...
class GUIHandler:
    def __init__(self):
        ...
        self.__txt_title = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((30,30), (5000,500)), text="Joel's A-maze-ing Game", manager=self.__gui_manager, container=self.__main_menu_panel)
        ...
        self.__txt_collectibles_collected = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((30,30), (5000,500)), text="Collectibles Collected: _/_", manager=self.__gui_manager, container=self.__level_panel)
        self.__txt_time_remaining = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((30,30), (5000,500)), text="Time Remaining: __:__", manager=self.__gui_manager, container=self.__level_panel)
        self.__btn_pause = pygame_gui.elements.UIButton(relative_rect=pygame.Rect((0,0), (100,100)), text="⏸", manager=self.__gui_manager, container=self.__level_panel)
        ...
        self.__txt_settings_bg_volume = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((20,100), (500,500)), text="Background Volume: __%", manager=self.__gui_manager, container=self.__settings_menu_panel)
        self.__slider_settings_bg_volume = pygame_gui.elements.UIHorizontalSlider(relative_rect=pygame.Rect((20,200), (1000,50)), start_value=50, value_range=(0,100), manager=self.__gui_manager, container=self.__settings_menu_panel)
        self.__txt_settings_sfx_volume = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((20,300), (500,500)), text="Sound Effects Volume: __%", manager=self.__gui_manager, container=self.__settings_menu_panel)
        self.__slider_settings_sfx_volume = pygame_gui.elements.UIHorizontalSlider(relative_rect=pygame.Rect((20,400), (1000,50)), start_value=50, value_range=(0,100), manager=self.__gui_manager, container=self.__settings_menu_panel)
        self.__txt_theme_subtitle = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((20,50), (500,500)), text="Theme Settings:", manager=self.__gui_manager, container=self.__settings_menu_panel)
        self.__drop_theme_section = pygame_gui.elements.UIDropDownMenu(options_list=["Background", "Text/Walls", "Buttons", "Highlights", "Player", "Enemy"], starting_option="Background", relative_rect=pygame.Rect((20,600),(200,50)), manager=self.__gui_manager, container=self.__settings_menu_panel)
        self.__colour_rect = pygame_gui.elements.UIPanel(relative_rect=pygame.Rect((20,700), (100,100)), manager=self.__gui_manager, container=self.__settings_menu_panel, object_id="#colour_rect")
        self.__txt_red_level = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((20,750), (500,500)), text="Red: __%", manager=self.__gui_manager, container=self.__settings_menu_panel)
        self.__slider_red_level = pygame_gui.elements.UIHorizontalSlider(relative_rect=pygame.Rect((400,750), (1000,50)), start_value=50, value_range=(0,100), manager=self.__gui_manager, container=self.__settings_menu_panel)
        self.__txt_green_level = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((20,750), (500,500)), text="Green: __%", manager=self.__gui_manager, container=self.__settings_menu_panel)
        self.__slider_green_level = pygame_gui.elements.UIHorizontalSlider(relative_rect=pygame.Rect((400,750), (1000,50)), start_value=50, value_range=(0,100), manager=self.__gui_manager, container=self.__settings_menu_panel)
        self.__txt_blue_level = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((20,750), (500,500)), text="Blue: __%", manager=self.__gui_manager, container=self.__settings_menu_panel)
        self.__slider_blue_level = pygame_gui.elements.UIHorizontalSlider(relative_rect=pygame.Rect((400,750), (1000,50)), start_value=50, value_range=(0,100), manager=self.__gui_manager, container=self.__settings_menu_panel)
        self.__txt_preset_themes = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((20,100), (500,500)), text="Preset Themes:", manager=self.__gui_manager, container=self.__settings_menu_panel)
        self.__btn_light_theme = pygame_gui.elements.UIButton(relative_rect=pygame.Rect((50,500), (100,100)), text="Light", manager=self.__gui_manager, container=self.__settings_menu_panel)
        self.__btn_dark_theme = pygame_gui.elements.UIButton(relative_rect=pygame.Rect((50,600), (100,100)), text="Dark", manager=self.__gui_manager, container=self.__settings_menu_panel)
        self.__btn_light_hc_theme = pygame_gui.elements.UIButton(relative_rect=pygame.Rect((50,700), (100,100)), text="Light\nHigh\nContrast", manager=self.__gui_manager, container=self.__settings_menu_panel)
        self.__btn_dark_hc_theme = pygame_gui.elements.UIButton(relative_rect=pygame.Rect((50,800), (100,100)), text="Dark\nHigh\nContrast", manager=self.__gui_manager, container=self.__settings_menu_panel)
        self.__btn_exit_settings = pygame_gui.elements.UIButton(relative_rect=pygame.Rect((50,900), (100,100)), text="Exit Settings", manager=self.__gui_manager, container=self.__settings_menu_panel)
